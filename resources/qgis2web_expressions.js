...
function exp_label_060_03102025060_30092025__baru_060_29092025__kdkec_060_1_eval_expression(context) {
    // nmsls || ', SUB-' || subsls || '\n' || kdprov || kdkab || kdkec || kddesa || kdsls

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((((((feature.get('nmsls')  + ', SUB-') + feature.get('subsls') ) + '\n') + feature.get('kdprov') ) + feature.get('kdkab') ) + feature.get('kdkec') ) + feature.get('kddesa') ) + feature.get('kdsls') );
    } else {
        return ((((((((feature.get('nmsls')  + ', SUB-') + feature.get('subsls') ) + '\n') + feature.get('kdprov') ) + feature.get('kdkab') ) + feature.get('kdkec') ) + feature.get('kddesa') ) + feature.get('kdsls') );
    }
}